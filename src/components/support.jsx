    ...
    return (
      <div className={css.support}>
        ...
        <div className={css.text2}>
          Here you can write us about your problems and we will gladly help you.
        </div>
        <div className={css.text3}>Ask your question here</div>
        <div>
          <textarea className={css.textArea} onChange={this.handleChange} value={this.state.val} />
        </div>
        <div
          className={css.send_btn}
          onClick={() => {
            this.send_support_request();
          }}
        >
          Send
        </div>
