...
class Menu extends Component {
  ...
  render () {
    ...
    let menu_items = ['E-commerce', 'Real estate', 'Personal service',
      'Finance', 'Telecom', 'Travel',
      'Media', 'Lawyer', 'Education', 'Entertainment', 'Personal assistant', 'Online services',
      'Corporate assistant'].map((name, i) => {
