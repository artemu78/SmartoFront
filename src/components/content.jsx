...
class Content extends Component {
  ...
  item_template(item, key = 0) {
    ...
    return (
      <div className='template' key={key}>
        ...
        <div className='viber'>
          <img alt='' src='img/viber.png' />
        </div>
        <div className='tm'>
          <img alt='' src='img/tm.png' />
        </div>
        <div className='fb'>
          <img alt='' src='img/fb.png' />
        </div>
        <div className='preview' onClick={(e) => this.display_template(item)}>
          Preview
        </div>
      </div>
    );
  ...
  render() {
    if (!this.props.show_content) return null;
    ...
    let items = [
      {
        ...
        bg: 'bg_1.jpg',
        full_descr:
          'helps users to pick up a product. helps users to pick up a product. helps users to pick up a product.helps users to pick up a product.helps users to pick up a product. helps users to pick up a product.helps users to pick up a product.helps users to pick up a product. helps users to pick up a product.'
      },
      {
      ...
      item_draggable = (
        <Draggable>
          <div className='template_full'>
            <i
              className='material-icons x_btn'
              onClick={(e) => {
