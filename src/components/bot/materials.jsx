    ...
    return (
      <div>
        <div className='text_input'>
          Company name
          <br />
          <input type='text' name='c_name' value={this.state.c_name} />
        </div>
        <div className='text_input'>
          About company
          <br />
          <textarea name='c_about' value={this.state.c_name} rows='3'></textarea>
        </div>
        <div className='text_input'>
          Phone number
          <br />
          <input type='text' name='c_phone' value={this.state.c_phone} />
        </div>
        <div className='text_input'>
          Site
          <br />
          <input type='text' name='c_site' value={this.state.c_site} />
        </div>
        <div className='text_input'>Company location</div>
        <div
          className='button'
          onClick={() => {
            // this.send();
