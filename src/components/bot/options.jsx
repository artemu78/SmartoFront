...
class BotOptions extends Component {
  ...
  handleResponseInfo(response) {
    var infoText =
      ...
      response.getWebhookInfo.pending_update_count +
      '\nlast_error_date=' +
      response.getWebhookInfo.last_error_date +
      '\nlast_error_message=' +
      response.getWebhookInfo.last_error_message +
      '\nfirst_name=' +
      response.getme.first_name +
      '\nid=' +
      response.getme.id +
      '\nusername=' +
      response.getme.username;
      ...
      <div className='bot_options'>
        ...
        <div className='text_input'>
          ...
          <div style={vk_style}>
            ...
            <span style={{ marginLeft: '60px', cursor: 'pointer' }} onClick={this.copyWidgetCode}>
              copy to clipboard
              <i
            ...
            <textarea
              ref={this.widgetCodeRef}
              name='owners'
              value={this.state.widget_code}
              rows='5'
              readOnly
            />
        ...
        <div style={vk_style}>
          <TextInput
            text='Token'
            name='chtfl'
            value={this.state.chtfl}
            onChange={this.handleChange}
          />
          <TextInput
            text='Id'
            name='chtfl_id'
            value={this.state.chtfl_id}
            onChange={this.handleChange}
          />
        </div>
        <div className='text_input'>
        ...
        <div style={vk_style}>
          ...
          <TextInput
            text='Token'
            name='vk_token'
            value={this.state.vk_token}
            onChange={this.handleChange}
          />
          <TextInput
            text='Secret'
            name='vk_secret'
            value={this.state.vk_secret}
            onChange={this.handleChange}
          />
          <TextInput
            text='Confirm'
            name='vk_confirm'
            value={this.state.vk_confirm}
            onChange={this.handleChange}
          />
        </div>
        <div className='text_input'>
