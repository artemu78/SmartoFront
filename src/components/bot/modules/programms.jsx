                  ...
                  <div class='panel-body'>
                    ...
                    <div class='form-group dropdown'>
                      ...
                      <ul class='dropdown-menu' aria-labelledby='dropdownMenu'>
                        <li>
                          <a href='javascript:void(0);' class='chText'>
                            Текстовое поле
                          </a>
                        </li>
                        <li>
                          <a href='javascript:void(0);' class='chLink'>
                            Ссылку
                          </a>
                        </li>
                        <li>
                          <a href='javascript:void(0);' class='chImg'>
                            Изображение
                          </a>
                        </li>
                      </ul>
                    ...
                    >
                      <div class='panel panel-default' data-num='1'>
                        <div class='panel-heading' role='tab'>
                          <h4 class='panel-title'>
                            <a
                              role='button'
                              data-toggle='collapse'
                              data-parent='#sub_accordion_1'
                              href='#sub_collapse_1_1'
                              aria-expanded='false'
                              aria-controls='sub_collapse_1_1'
                            >
                              Спикер
                            </a>
                            <a
                            ...
                            <a href='javascript:void(0);' class='btn pull-right'>
                              <span
                                class='glyphicon glyphicon-minus subMinus'
                                aria-hidden='true'
                              ></span>
                            </a>
                          </h4>
                        ...
                        >
                          <div class='panel-body'>
                            ...
                            <div class='form-group lnkGroup'>
                              <div
                                class='btn-group-vertical lnkInputBlock'
                                role='group'
                                aria-label='...'
                              >
                                <input
                        ...
                        <div class='panel-heading' role='tab'>
                          <h4 class='panel-title'>
                            <a
                              ...
                              aria-expanded='false'
                              aria-controls='sub_collapse_1_2'
                            >
                              Формат и цена
                            </a>
                            <a
                        ...
                        <div class='panel-heading' role='tab'>
                          <h4 class='panel-title'>
                            <a
                              ...
                              aria-expanded='false'
                              aria-controls='sub_collapse_1_3'
                            >
                              Тема и тезисы
                            </a>
                            <a
                      ...
                      <a
                        class='btn btn-success chSubBlock'
...
export default connect(mapStateToProps)(ProgrammsModule);
