...
const EventRow = (props) => {
  const { event, allPossibleEvents, allPossibleActions, schemes, bot, allPossiblePolls, setEventItem } = props;
  ...
  if (mode === 'view')
    rowContent = (
      <TableRow key={event.event_id}>
        ...
        <TableCell key="4">
          <Fab color="primary" aria-label="edit" onClick={setViewMode('edit')}><Edit/></Fab>
        </TableCell>
      </TableRow>
    )
  else
    rowContent = (<EventAddItem {...addEvensProps}/>)
  return rowContent;
}
