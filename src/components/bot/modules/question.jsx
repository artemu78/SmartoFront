                  ...
                  <div class="panel-heading" role="tab">
                    <h4 class="panel-title">
                      <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse_1"
                        aria-expanded="false" aria-controls="collapse_1">Общий вопрос</a>
                  ...
                  <div id="collapse_1" class="panel-collapse collapse" role="tabpanel"
                    ...
                    <div class="panel-body">
                      ...
                      <div class="form-group txtGroup">
                        ...
                        <input class="form-control pull-right" placeholder="Ссылка на профиль оператора"/>
                      </div>
                  ...
                  <div class="panel-heading" role="tab">
                    <h4 class="panel-title">
                      <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse_2"
                        aria-expanded="false" aria-controls="collapse_2">Обучение</a>
                      <a href="#" class="btn btn-edit" data-toggle="modal" data-target="#editModal">
                        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                      </a>
                      <a href="javascript:void(0);" class="btn pull-right">
                  ...
                  <div class="panel-heading" role="tab">
                    <h4 class="panel-title">
                      <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse_3"
                        aria-expanded="false" aria-controls="collapse_3">Инвестиции</a>
                      <a href="#" class="btn btn-edit" data-toggle="modal" data-target="#editModal">
                        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                      </a>
                      <a href="javascript:void(0);" class="btn pull-right">
