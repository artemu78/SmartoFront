...
if (PROD_BUILD) remote_path_yandex = '/var/www/html/';
...
sftp_yandex
  .connect({
    ...
    port: 22,
    username: 'aehafgdz',
    privateKey: process.env.privatekey, // Buffer or string that contains
    passphrase: process.env.passphrase // string - For an encrypted private key
  })
  .then(() => {
    let promises = [];
